...
from PD_NOMA_AOI3 import users

# ---------------------- configure your base directory here ----------------------
BASE_DIR = "/Users/muhammadtauseefmushtaq/Documents/GitHub/AoI_PD_NOMA_PPO2/AoI_S7"
...
# ---------------------- top-level plotting -------------------------------------
def plot_final_aoi_vs_slots(M_list,
                            slots,
    ...
    for M in M_list:
        run_dir = os.path.join(BASE_DIR, f"AoI_U{M}_S{slots}_SLT")
        val = load_final_aoi_from_run_dir(run_dir, M, slots,
                                          frames_per_episode=frames_per_episode,
                                          num_episodes=num_episodes,
                                          verbose=True)
        xs.append(M)
...
if __name__ == "__main__":
    ...
    USER_LIST = (13, 16, 19, 23, 27, 30, 35, 40, 45, 50)

    plot_final_aoi_vs_slots(M_list = USER_LIST,
                            slots =num_slots,
                            frames_per_episode=FRAMES_PER_EPISODE,
                            num_episodes=NUM_EPISODES)
